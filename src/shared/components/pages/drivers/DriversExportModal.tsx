...
interface DriversExportModalProps {
  open: boolean;
  loading: boolean;
...
const DriversExportModal = ({
  ...
  return (
    <CommonModal open={open} onOpenChange={onOpenChange} loading={loading} maxWidth="sm:max-w-[520px]">
      <CommonModalHeader
        title={t("drivers:export.title")}
        description={t("drivers:export.description")}
      />
      ...
      <CommonModalBody className="space-y-4">
        <div className="flex items-center gap-3 px-4 py-3 bg-main-primary/5 border border-main-primary/15 rounded-xl">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-main-sharkGray">{t("drivers:export.dateHint")}</p>
          </div>
...
export default DriversExportModal;
